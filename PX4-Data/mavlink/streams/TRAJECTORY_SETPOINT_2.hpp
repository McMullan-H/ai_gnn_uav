...
#ifndef TRAJECTORY_SETPOINT_2_HPP
#define TRAJECTORY_SETPOINT_2_HPP

class MavlinkStreamTrajectorySetpoint2 : public MavlinkStream, public ModuleParams {
public:
    static MavlinkStream *new_instance(Mavlink *mavlink)    { return new MavlinkStreamTrajectorySetpoint2(mavlink); }
    const char *get_name() const                            { return MavlinkStreamTrajectorySetpoint2::get_name_static(); }
    static const char *get_name_static()                    { return "TRAJECTORY_SETPOINT_2"; }
...
private:
    ...
    uORB::Subscription _trajectory_setpoint_2_sub{ORB_ID::trajectory_setpoint_2};
    uORB::SubscriptionInterval _parameter_update_sub{ORB_ID(parameter_update), 1_s};

protected:
    explicit MavlinkStreamTrajectorySetpoint2(Mavlink *mavlink) : 
    ...
    bool send() override{
        ...
        if(_param_gnn_telem_enable.get()){
            ...
            _trajectory_setpoint_2_sub.copy(&setpoint);
...
void MavlinkStreamTrajectorySetpoint2::parameters_update(){
