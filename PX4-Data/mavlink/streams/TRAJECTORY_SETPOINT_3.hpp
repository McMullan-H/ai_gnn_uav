...
#ifndef TRAJECTORY_SETPOINT_3_HPP
#define TRAJECTORY_SETPOINT_3_HPP

class MavlinkStreamTrajectorySetpoint3 : public MavlinkStream, public ModuleParams {
public:
    static MavlinkStream *new_instance(Mavlink *mavlink)    { return new MavlinkStreamTrajectorySetpoint3(mavlink); }
    const char *get_name() const                            { return MavlinkStreamTrajectorySetpoint3::get_name_static(); }
    static const char *get_name_static()                    { return "TRAJECTORY_SETPOINT_3"; }
...
private:
    ...
    uORB::Subscription _trajectory_setpoint_3_sub{ORB_ID::trajectory_setpoint_3};
    uORB::SubscriptionInterval _parameter_update_sub{ORB_ID(parameter_update), 1_s};

protected:
    explicit MavlinkStreamTrajectorySetpoint3(Mavlink *mavlink) : 
    ...
    bool send() override{
        ...
        if(_param_gnn_telem_enable.get()){
            ...
            _trajectory_setpoint_3_sub.copy(&setpoint);
...
void MavlinkStreamTrajectorySetpoint3::parameters_update(){
