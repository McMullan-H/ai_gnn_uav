...
#ifndef TRAJECTORY_SETPOINT_4_HPP
#define TRAJECTORY_SETPOINT_4_HPP

class MavlinkStreamTrajectorySetpoint4 : public MavlinkStream, public ModuleParams {
public:
    static MavlinkStream *new_instance(Mavlink *mavlink)    { return new MavlinkStreamTrajectorySetpoint4(mavlink); }
    const char *get_name() const                            { return MavlinkStreamTrajectorySetpoint4::get_name_static(); }
    static const char *get_name_static()                    { return "TRAJECTORY_SETPOINT_4"; }
...
private:
    ...
    uORB::Subscription _trajectory_setpoint_4_sub{ORB_ID::trajectory_setpoint_4};
    uORB::SubscriptionInterval _parameter_update_sub{ORB_ID(parameter_update), 1_s};

protected:
    explicit MavlinkStreamTrajectorySetpoint4(Mavlink *mavlink) : 
    ...
    bool send() override{
        ...
        if(_param_gnn_telem_enable.get()){
            ...
            _trajectory_setpoint_4_sub.copy(&setpoint);
...
void MavlinkStreamTrajectorySetpoint4::parameters_update(){
